 ...
 *   + n2: 0
 *
 * Generated at: 2020-07-15 15:56:18.168845
 *
 */
#include <stdlib.h>
 ...
 */
extern int phi_YeVItApFpybNBBWVZizE(
 ...
 */
extern int grad_phi_YeVItApFpybNBBWVZizE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_YeVItApFpybNBBWVZizE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_YeVItApFpybNBBWVZizE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
...
int cost_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    return phi_YeVItApFpybNBBWVZizE(
        args__,
        result_space_cost,
...
int grad_cost_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_YeVItApFpybNBBWVZizE(
        args__,
        result_space_grad,
...
int mapping_f1_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_YeVItApFpybNBBWVZizE
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_YeVItApFpybNBBWVZizE(
        args__,
        result_space_f1,
...
int mapping_f2_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_YeVItApFpybNBBWVZizE
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_YeVItApFpybNBBWVZizE(
        args__,
        result_space_f2,
