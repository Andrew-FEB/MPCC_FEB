...
#define MPCC_OPTIMIZER_N1 40

#define MPCC_OPTIMIZER_N2 0

#define MPCC_OPTIMIZER_NUM_DECISION_VARIABLES 40

#define MPCC_OPTIMIZER_NUM_PARAMETERS 48
...
} mpcc_optimizerExitStatus;

/**
 * Solver cache (structure `mpcc_optimizerCache`)
 */
typedef struct mpcc_optimizerCache mpcc_optimizerCache;
 ...
 */
mpcc_optimizerCache *mpcc_optimizer_new(void);
