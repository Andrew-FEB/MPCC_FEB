...
extern "C" {
    fn cost_function_mpcc_optimizer(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double) -> c_int;
    fn grad_cost_function_mpcc_optimizer(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double)
        -> c_int;
    fn mapping_f1_function_mpcc_optimizer(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn mapping_f2_function_mpcc_optimizer(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
} // END of extern C
...
pub fn mapping_f2(
    ...
    unsafe {
         mapping_f2_function_mpcc_optimizer(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
