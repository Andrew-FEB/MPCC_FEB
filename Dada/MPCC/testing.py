...
track_error_weight = [1, 0, 0.04, 0]  # contouring, tracking, velocity, phi
...
state_seq, ref_seq, nearest_seq, cost_seq, input_seq, controls_seq, sim_steps = sim.simulate(track_x, track_y, sim_steps)
