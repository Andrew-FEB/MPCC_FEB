...
//
// Generated at: 2020-05-16 17:35:09.051237
//
...
const SET_C_XMIN :Option<&[f64]> = Some(&[-30.0,-30.0,-10.0,-0.1,-2.0,-7.0,-0.1,-29.0,-1.5,]);
const SET_C_XMAX :Option<&[f64]> = Some(&[30.0,30.0,10.0,4.0,2.0,7.0,1.0,29.0,1.5,]);
