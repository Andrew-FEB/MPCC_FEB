...
//
// Generated at: 2020-05-12 17:49:41.183811
//
...
const SET_C_XMIN :Option<&[f64]> = Some(&[-30.0,-30.0,-10.0,-0.1,-2.0,-7.0,-0.1,-29.0,]);
const SET_C_XMAX :Option<&[f64]> = Some(&[30.0,30.0,10.0,4.0,2.0,7.0,1.0,29.0,]);
