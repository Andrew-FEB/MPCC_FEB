...
/// Initial penalty
const INITIAL_PENALTY_PARAMETER: f64 = 4.0;
...
const SET_C_XMIN :Option<&[f64]> = Some(&[0.5,0.5,-1.0,-0.506,0.0,0.0,]);
const SET_C_XMAX :Option<&[f64]> = Some(&[50.0,50.0,1.0,0.506,21430779576921.0,21430779576921.0,]);
