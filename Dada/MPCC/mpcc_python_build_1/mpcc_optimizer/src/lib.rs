...
//
// Generated at: 2020-03-15 10:17:22.467725
//
...
const PENALTY_UPDATE_FACTOR: f64 = 16.0;
...
const SET_C_XMIN :Option<&[f64]> = Some(&[-3.141592653589793,0.5,0.5,-6.283185307179586,-1.0,-0.506,-9.0,]);
const SET_C_XMAX :Option<&[f64]> = Some(&[3.141592653589793,50.0,50.0,6.283185307179586,1.0,0.506,9.0,]);
