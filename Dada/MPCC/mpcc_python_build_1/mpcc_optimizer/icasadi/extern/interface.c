 ...
 *   + n2: 0
 *
 * Generated at: 2020-03-27 16:57:01.823921
 *
 */
#include <stdlib.h>
...
#define NU_MPCC_OPTIMIZER 200

/* Number of static parameters */
#define NP_MPCC_OPTIMIZER 11

/* Dimension of F1 (number of ALM constraints) */
#define N1_MPCC_OPTIMIZER 500

/* Dimension of F2 (number of PM constraints) */
#define N2_MPCC_OPTIMIZER 0

/* Dimension of xi = (c, y) */
#define NXI_MPCC_OPTIMIZER 501
 ...
 */
extern int phi_GagjYsSrrmySDbAGzDlE(
 ...
 */
extern int grad_phi_GagjYsSrrmySDbAGzDlE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_GagjYsSrrmySDbAGzDlE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_GagjYsSrrmySDbAGzDlE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
...
int cost_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    return phi_GagjYsSrrmySDbAGzDlE(
        args__,
        result_space_cost,
...
int grad_cost_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_GagjYsSrrmySDbAGzDlE(
        args__,
        result_space_grad,
...
int mapping_f1_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_GagjYsSrrmySDbAGzDlE
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_GagjYsSrrmySDbAGzDlE(
        args__,
        result_space_f1,
...
int mapping_f2_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_GagjYsSrrmySDbAGzDlE
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_GagjYsSrrmySDbAGzDlE(
        args__,
        result_space_f2,
