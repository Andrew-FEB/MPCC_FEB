 ...
 *   + n2: 160
 *
 * Generated at: 2020-02-29 11:06:17.754464
 *
 */
#include <stdlib.h>
...
#define NP_MPCC_OPTIMIZER 166

/* Dimension of F1 (number of ALM constraints) */
#define N1_MPCC_OPTIMIZER 0

/* Dimension of F2 (number of PM constraints) */
#define N2_MPCC_OPTIMIZER 160

/* Dimension of xi = (c, y) */
#define NXI_MPCC_OPTIMIZER 1
 ...
 */
extern int phi_zAhGMBmvgYWajEoGQHhC(
 ...
 */
extern int grad_phi_zAhGMBmvgYWajEoGQHhC(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_zAhGMBmvgYWajEoGQHhC(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_zAhGMBmvgYWajEoGQHhC(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
...
int cost_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    return phi_zAhGMBmvgYWajEoGQHhC(
        args__,
        result_space_cost,
...
int grad_cost_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_zAhGMBmvgYWajEoGQHhC(
        args__,
        result_space_grad,
...
int mapping_f1_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_zAhGMBmvgYWajEoGQHhC
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_zAhGMBmvgYWajEoGQHhC(
        args__,
        result_space_f1,
...
int mapping_f2_function_mpcc_optimizer(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_zAhGMBmvgYWajEoGQHhC
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_zAhGMBmvgYWajEoGQHhC(
        args__,
        result_space_f2,
