...
inline void Visualise::waitForSubscribe(const ros::Publisher &pub)
{
...
void Visualise::configROS()
{
	n = std::make_unique<ros::NodeHandle>();
	ros::Rate r(RATE_VAL);
}

void Visualise::refreshRosOutput()
{
	if (ros::ok())
	{
...
void Visualise::showTriangles(const std::vector<triang>& triangles)
{
...
void Visualise::showCones(const std::vector < std::unique_ptr<Cone>> & coneList)
{
...
void Visualise::showCar(const std::unique_ptr<Car> &car)
{
...
void Visualise::showEndPoint(const coord &endPoint)
{
...
void Visualise::showCentreCoords(const std::vector<coord> &centreCoords)
{
...
void Visualise::showNodeMids(const std::vector<coord> &midPoints)
{
...
void Visualise::showNodeParentLinks(const std::vector<std::pair<coord, coord>> &connections)
{
